            ...
            <CenteredLayout logo={true} title="Регистрация">
                <div className="card">
                    <div style={{padding: "2rem 6rem"}}>
                        ...
                        <p>{this.props.user.name} ({this.props.user.sex}), {this.props.user.birthday}</p>
                    </div>
                        ...
                        <form className="" onSubmit={this.submitForm.bind(this)}>
                            ...
                            <div className="form-group">
                                ...
                                <input type="text" name="name" className="form-control"
                                       placeholder="Введите полные имя и фамилию" onChange={this.changeName.bind(this)}/>
                            </div>
                            <div className="form-group">
                                <label className="">Дата рождения</label>
                                <input type="date" name="birthday" className="form-control" onChange={this.changeBirthday.bind(this)}/>
                            </div>
                            <button className="btn btn-primary btn-block btn-lg">Зарегистрироваться</button>
                        </form>
                    </div>
                </div>
            </CenteredLayout>
